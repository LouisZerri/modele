...
class Men
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Country::class, inversedBy="men")
    ...
    /**
     * @ORM\OneToMany(targetEntity=PictureMen::class, mappedBy="men", orphanRemoval=true, cascade={"persist"})
     */
    private $pictures;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Face::class, inversedBy="men")
     * @ORM\JoinColumn(nullable=false)
     */
    private $face;
    ...
    /**
     * Get mimeTypes={"image/jpg", "image/jpeg", "image/png"}
     *
     * @return  File|null
     */ 
    ...
    /**
     * Set mimeTypes={"image/jpg", "image/jpeg", "image/png"}
     *
     * @param  File|null  $imageFile  mimeTypes={"image/jpg", "image/jpeg", "image/png"}
     *
     * @return  self
     */ 
    ...
    public function addPicture(PictureMen $picture): self
    {
    ...
    public function removePicture(PictureMen $picture): self
    {
        if ($this->pictures->removeElement($picture)) {
            // set the owning side to null (unless already changed)
            if ($picture->getMen() === $this) {
                $picture->setMen(null);
            }
        }
